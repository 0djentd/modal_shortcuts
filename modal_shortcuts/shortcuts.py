...
class ModalShortcutsGroup(CachedObject, ExtendedList):
    ...
    def add(self, shortcut, index=None):
        if self.find_by_shortcut_id(shortcut.shortcut_id):
            self._data.remove(
                self.self.find_by_shortcut_id(shortcut.shortcut_id))
...
class ModalShortcutsCache(CachedObject, ExtendedList):
